...
function() {
    ...
    jQuery(".error").hide(), jQuery("#BusinessAssociation").click(function() {
        ...
        var f = jQuery("input#var_name").val();
        if ("YOUR firstname *" == f || "" == f) return jQuery("span#var_name_error").show(), jQuery("input#var_name").focus(), !1;
        var d = /^[a-zA-Z-,]+(\s{0,1}[a-zA-Z-, ])+(\s{0,1}[a-zA-Z-, ])*$/;
        if (!d.test(f)) return jQuery("span#var_name_error").show(), jQuery("input#var_name").focus(), !1;

        var s = jQuery("input#var_flat").val();
        if ("" == s) return jQuery("span#var_flat_error").show(), jQuery("input#var_flat").focus(), !1;


        var sm = jQuery("input#var_budget").val();
        if ("" == sm) return jQuery("span#var_budget_error").show(), jQuery("input#var_budget").focus(), !1;

        var sm = jQuery("input#var_city").val();
        if ("" == sm) return jQuery("span#var_city_error").show(), jQuery("input#var_city").focus(), !1;

       /* var m = jQuery("input#var_budget").val();
        if ("Approx Budget *" == m || "" == m) return jQuery("span#var_budget_error").show(), jQuery("input#var_budget").focus(), !1;
        var h = /^[a-zA-Z-,]+(\s{0,1}[a-zA-Z-, ])+(\s{0,1}[a-zA-Z-, ])*$/;
        if (!h.test(m)) return jQuery("span#var_budget_error").show(), jQuery("input#var_budget").focus(), !1;*/


       /*   var x = jQuery("input#var_budget").val();
        if ("YOUR NAME *" == x || "" == x) return jQuery("span#var_budget_error").show(), jQuery("input#var_budget").focus(), !1;
        var y = /^[a-zA-Z-,]+(\s{0,1}[a-zA-Z-, ])+(\s{0,1}[a-zA-Z-, ])*$/;
        if (!y.test(x)) return jQuery("span#var_budget_error").show(), jQuery("input#var_budget").focus(), !1;*/
     ...
     /*   var x = jQuery("input#var_budget").val();
        ...
        /* var pn = jQuery("input#var_budget").val();
        if ("PAN Number *" == pn || "" == pn) return jQuery("span#var_budget_error").show(), jQuery("input#var_budget").focus(), !1;
        var h = /^([a-zA-Z]){5}([0-9]){4}([a-zA-Z]){1}?$/;
        if (!h.test(pn)) return jQuery("span#var_budget_error").show(), jQuery("input#var_budget").focus(), !1;
*/
        /*var b = jQuery("input#var_city").val();
        if ("YOUR NAME *" == b || "" == b) return jQuery("span#var_city_error").show(), jQuery("input#var_city").focus(), !1;
        var d = /^[a-zA-Z-,]+(\s{0,1}[a-zA-Z-, ])+(\s{0,1}[a-zA-Z-, ])*$/;
        if (!d.test(b)) return jQuery("span#var_city_error3").show(), jQuery("input#var_city").focus(), !1;*/
    ...
    /*    var p = jQuery("input#var_mobileno").val();
        if ("PHONE *" == p || "" == p) return jQuery("span#var_mobileno_error").show(), jQuery("input#var_mobileno").focus(), !1;
        var h = /^\d{10}$/;
        if (!h.test(p)) return jQuery("span#var_mobileno_error").show(), jQuery("input#var_mobileno").focus(), !1;*/
