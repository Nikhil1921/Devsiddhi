<div class="content">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo base_url('admin/category/category_insert_data'); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                <input type="hidden" name="image" value="">
                <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="c_name" class="col-form-label">Category Name</label>                        <input type="text" name="var_name" value="" class="form-control" id="c_name" maxlength="100" required="" placeholder="Enter Category Name">
                            </div>
                        </div>
