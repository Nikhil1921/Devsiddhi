                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                         <a onclick="return confirm('Are you sure?')" href="<?php echo base_url('admin/broker/delete_data/'.$value['id']); ?>"><button class="btn btn-outline-primary btn-round">
