...
<main class="main-content">
  <div class="heading-image-title" data-bg-grab data-full-height="0.75"> <img width="1800" height="927" src="images/Complited/Devsiddhi-Castle/ENTGATE.jpg" alt="" />
    <div class="heading-image-title__wrapper">
        <div class="slider__content slider-con">
        <div class="container">
          <div class="slider__content-wrap">
            <h1 class="text-uppercase">Devsiddhi Castle</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="image-gallery">
    <div class="grid grid--padding-twelvefive">
      <div class="grid__cell grid__cell--one-third grid__cell--image-gallery">
        <div class="image-gallery__image-container" data-bg-grab> <img width="1192" height="716" src="images/Complited/Devsiddhi-Castle/STREETVIEW.jpg" alt="" /> <a class="image-gallery__image-link mfp-image" href="images/Complited/Devsiddhi-Castle/STREETVIEW.jpg" data-mfp="images/Complited/Devsiddhi-Castle/STREETVIEW.jpg"></a></div>
      </div>
      <div class="grid__cell grid__cell--one-third grid__cell--image-gallery">
    ...
    <div class="container">
      <div class="grid grid--padding-large">
        <div class="grid__cell grid__cell--one-half contact-form__cell">
          <h1 class="contact-form__heading">Devsiddhi Castle</h1>
